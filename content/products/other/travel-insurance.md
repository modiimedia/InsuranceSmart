...
mikes_take = "When traveling outside the United States you don't want to be left without medical and emergency coverage. We've researched and found a really robust plan that provides a full array of travel and international medical coverage that even includes options to help with cost of an emergency evacuation and / or confinement. This product is perfect whether traveling on a short or long term vacation, have global lifestyle with multiple trips in a year, work or study abroad long or short term,  exchange and foreign studies, and sophisticated travelers. From a 2 week leisure trip to a semester or 4 year decree, to a 2 year work assignment. \n\nThis product provides downloadable mobile app for both Android or IPhone that allows you to access to in-depth profiles of carefully selected doctors, dentists, hospitals and clinics around the world and search based upon your GPS location. In addition, many of these plans include costs associated with trip interruptions and displacements caused by illness, medical emergency or even a terrorist event or political unrest, and can help cover expense related to trip delays, schedule changes, and emergency evacuations.  \n\nTake time to review options carefully and when you find what works, you can enroll right on line.  I do suggest you book the coverage past your scheduled return date however. This will insure coverage is in place should an unexpected delay occur in your travelbecause you cannot purchase additional days once you depart the country. \n\nJ you have questions or need help,, give us a call and we can walk you through it."
