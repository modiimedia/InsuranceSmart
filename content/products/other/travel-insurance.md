...
faqs = []
featured_image = ""
mikes_take = "This is a really robust plan that provides a full array of travel and international medical plans for global lifestyles and sophisticated travelers. From a 2 week leisure trip to a 2 year work assignment. You gain access to in-depth profiles of carefully selected doctors, dentists, hospitals and clinics around the world. In addition, many of these plans include costs associated with trip interruptions and displacements caused by illness, medical emergency or even terrorist event, and can help cover expense related to trip delays, schedule changes, and emergency evacuations.  Take time to review options carefully and when you find what works for you you can enroll right on line.  Or just give us a call and we can walk you through it. "
